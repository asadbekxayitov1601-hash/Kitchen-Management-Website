...
import { Clock, Users, Plus, ChevronRight, Heart } from 'lucide-react';
...
export function RecipeCard({ recipe, isFavorite, onAddToShoppingList, onViewRecipe, onToggleFavorite }: RecipeCardProps) {
  return (
    ...
    >
      <div className="h-full flex flex-col rounded-3xl overflow-hidden bg-white border border-gray-100 shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-300">
        ...
        <div className="p-5 flex-1 flex flex-col">
          ...
          <div className="mt-auto pt-4 border-t border-gray-50 flex items-center gap-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-primary/80 text-white rounded-xl px-4 py-3 hover:shadow-lg hover:shadow-primary/30 active:scale-[0.98] transition-all duration-300 group/add"
            >
